...
void setup() {
  ...
  bouncer = new Bouncer(width/2,height/2,20,20,50,color(150,0,0,50),color(255,0,0,50));
  bouncer2 = new Bouncer(width/2,height/2,-20,20,50,color(0,0,150,50),color(0,0,255,50));
}
